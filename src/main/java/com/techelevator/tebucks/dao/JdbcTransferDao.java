...
public class JdbcTransferDao implements TransferDao{
    ...
    public Transfer updateTransfer(Transfer transfer) {
        ...
        try {
            int rowsAffected = jdbcTemplate.update(sql, transfer.getToUserId(), transfer.getFromUserId(), transfer.getTransferType(),transfer.getAmount(), transfer.getTransferStatus(), transfer.getTransferId());
            if (rowsAffected == 0) {
